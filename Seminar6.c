...
{ 
	//ii alocam spatiu pe heap, nu pe stack, il luam drept pointer
...
void main()
{
	...
	ListaDubla listaDubla;// obiect, fie il returnam fie il transmitem prin pointer
	listaDubla.head = NULL;
	listaDubla.tail = NULL;
